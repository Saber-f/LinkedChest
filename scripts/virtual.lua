        ...
        if entity.type == "assembling-machine" or entity.type == "furnace" then 
            ...
            if recipe ~= nil and entity.electric_drain ~= nil then
                ...
                if global.virtual[force.name][recipe.name] == nil then
                    ...
                    vinfo.productivity_bonus  = (vinfo.productivity_bonus * vinfo.speed + (entity.productivity_bonus + 1) * entity.speed) / (vinfo.speed + entity.speed)
                ...
                if game.tick - vinfo.tick >= 15 then
                    ...
                    if count > 1 then
                        ...
                        for _, product in pairs(products) do
                            ...
                            local add_count = math.floor(product_amount * count * vinfo.productivity_bonus + 0.5)
                            add_force_item(force.name, product_name, add_count)
                            game.print("[recipe="..recipe_name.."]生产了"..add_count.."个[item="..product_name.."],game.tick="..game.tick)
                        end
