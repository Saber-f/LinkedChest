...
function name2id(force,name,surface)
    ...
    if global.name2id[force][name] == nil then
        ...
        game.print("新id:图层:"..surface.name.."index:"..surface.index)
    else
        id = global.name2id[force][name]
        game.print("旧id:图层:"..surface.name.."index:"..surface.index)
    end
    ...
    for i = 1, settings.global["checkCount"].value, 1 do
        ...
        if entity and entity.valid then
            ...
            if entity.surface.index ~= link_id % 2^6 then
                ...
                entity.force.print("警告！非法关联箱图层修改:"..entity.surface.index.."->"..errorindex.."(已修复)最后操作者:"..entity.last_user.name)
            end
